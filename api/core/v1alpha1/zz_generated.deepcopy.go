...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LACPStatus) DeepCopyInto(out *LACPStatus) {
	*out = *in
	if in.LACPDUsSent != nil {
		in, out := &in.LACPDUsSent, &out.LACPDUsSent
		*out = new(uint64)
		**out = **in
	}
	if in.LACPDUsReceived != nil {
		in, out := &in.LACPDUsReceived, &out.LACPDUsReceived
		*out = new(uint64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LACPStatus.
func (in *LACPStatus) DeepCopy() *LACPStatus {
	if in == nil {
		return nil
	}
	out := new(LACPStatus)
