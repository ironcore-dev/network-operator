...
func (in *AAAAuthentication) DeepCopyInto(out *AAAAuthentication) {
	*out = *in
	if in.Login != nil {
		...
		*out = new(AAAAuthenticationLogin)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AAAAuthenticationLogin) DeepCopyInto(out *AAAAuthenticationLogin) {
	*out = *in
	if in.Default != nil {
		in, out := &in.Default, &out.Default
		*out = new(AAAMethodList)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AAAAuthenticationLogin.
func (in *AAAAuthenticationLogin) DeepCopy() *AAAAuthenticationLogin {
	if in == nil {
		return nil
	}
	out := new(AAAAuthenticationLogin)
...
func (in *AAAAuthorization) DeepCopyInto(out *AAAAuthorization) {
	*out = *in
	if in.ConfigCommands != nil {
		...
		*out = new(AAAAuthorizationConfigCommands)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AAAAuthorizationConfigCommands) DeepCopyInto(out *AAAAuthorizationConfigCommands) {
	*out = *in
	if in.Default != nil {
		in, out := &in.Default, &out.Default
		*out = new(AAAMethodList)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AAAAuthorizationConfigCommands.
func (in *AAAAuthorizationConfigCommands) DeepCopy() *AAAAuthorizationConfigCommands {
	if in == nil {
		return nil
	}
	out := new(AAAAuthorizationConfigCommands)
...
func (in *AAASpec) DeepCopyInto(out *AAASpec) {
	*out = *in
	...
	if in.TACACSServers != nil {
		in, out := &in.TACACSServers, &out.TACACSServers
		*out = make([]TACACSServer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TACACSGroup != nil {
		in, out := &in.TACACSGroup, &out.TACACSGroup
		*out = new(TACACSGroup)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TACACSGroup) DeepCopyInto(out *TACACSGroup) {
	*out = *in
	if in.Servers != nil {
		in, out := &in.Servers, &out.Servers
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TACACSGroup.
func (in *TACACSGroup) DeepCopy() *TACACSGroup {
	if in == nil {
		return nil
	}
	out := new(TACACSGroup)
