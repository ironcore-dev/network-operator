...
// NVESpec defines the desired state of a VXLAN Tunnel Endoint (NVE); in OpenConfig: an Endpoint for a Network Virtualization Overlay Object.
...
// +kubebuilder:resource:path=nves
// +kubebuilder:resource:singular=nve
...
// NVE is the Schema for the nves API
type NVE struct {
...
func (in *NVE) GetConditions() []metav1.Condition {
	return in.Status.Conditions
}

// SetConditions implements conditions.Setter.
func (in *NVE) SetConditions(conditions []metav1.Condition) {
...
var (
	NVEDependencies   []schema.GroupVersionKind
	nveDependenciesMu sync.Mutex
)

// RegisterNVEDependency adds GVKs to the NVE dependency registry.This function is typically
...
func RegisterNVEDependency(gvk schema.GroupVersionKind) {
	nveDependenciesMu.Lock()
	defer nveDependenciesMu.Unlock()
	NVEDependencies = append(NVEDependencies, gvk)
}
