...
func (in *ISISStatus) DeepCopyInto(out *ISISStatus) {
	*out = *in
	...
	if in.CurrentAdjacencies != nil {
		in, out := &in.CurrentAdjacencies, &out.CurrentAdjacencies
		*out = new(int32)
		**out = **in
	}
	if in.ExpectedAdjacencies != nil {
		in, out := &in.ExpectedAdjacencies, &out.ExpectedAdjacencies
		*out = new(int32)
		**out = **in
	}
}
