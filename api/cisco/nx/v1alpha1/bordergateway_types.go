...
type InterconnectInterfaceReference struct {
	...
	// DCI tracking is used for Data Center Interconnect interfaces, while Fabric tracking
	// is used for fabric-facing interfaces.
	// +required
...
// +kubebuilder:validation:Enum=DCI;Fabric
type InterconnectTrackingType string

const (
	// InterconnectTrackingTypeDCI represents DCI (Data Center Interconnect) tracking mode.
	// Used for interfaces connecting to remote data centers.
	InterconnectTrackingTypeDCI InterconnectTrackingType = "DCI"
