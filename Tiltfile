...
k8s_resource(new_name='leaf1', objects=['leaf1:device', 'secret-basic-auth:secret', 'network-operator:issuer', 'network-operator-ca:certificate'], trigger_mode=TRIGGER_MODE_MANUAL, auto_init=False)
