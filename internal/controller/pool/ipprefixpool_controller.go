...
// IPPrefixPoolReconciler reconciles an IPPrefixPool object
type IPPrefixPoolReconciler struct {
	client.Client
...
func (r *IPPrefixPoolReconciler) SetupWithManager(mgr ctrl.Manager) error {
