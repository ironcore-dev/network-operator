...
// +kubebuilder:rbac:groups=networking.cloud.sap,resources=syslogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networking.cloud.sap,resources=syslogs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=networking.cloud.sap,resources=syslogs/finalizers,verbs=update
...
func (r *SyslogReconciler) reconcile(ctx context.Context, s *syslogScope) (_ ctrl.Result, reterr error) {
	...
	if !controllerutil.HasControllerReference(s.Syslog) {
		if err := controllerutil.SetOwnerReference(s.Device, s.Syslog, r.Scheme); err != nil {
			return ctrl.Result{}, err
		}
	}
