...
type DeviceProvider interface {
	...
	Reboot(context.Context, *deviceutil.Connection, bool) error
...
type ProvisioningProvider interface {
	...
	// VerifyProvisioningCompleted checks if the provisioning process has been completed successfully on the device.
	VerifyProvisioningCompleted(context.Context, *deviceutil.Connection, *v1alpha1.Device) bool
}
